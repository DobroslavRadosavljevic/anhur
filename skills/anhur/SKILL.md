...
description: >-
  ...
  anhur/generated imports, the Vite plugin, CLI build/watch, drafts/hooks,
  MDX/Markdown bodies, assets, CDN/object storage upload (assets storage +
  files-sdk), or full-text search — or when the user mentions Anhur, .anhur,
  cms/, or local MD/MDX/YAML/JSON content pipelines.
license: MIT
metadata:
  version: "0.0.11"
...
12. Localization: folder strategy under `{directory}/{locale}/…` when `localization` is set; use `localized: false` per source for monolingual trees. Do not invent a parallel i18n content layout.
